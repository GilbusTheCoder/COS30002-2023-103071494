...
from soldier import Soldier, WEAPONS, PATROL_STATES
    ...
    if symbol == KEY.I:
        ...
        for object in world.objects:
            if type(object) == Soldier:
                ...
                if object.weapon != WEAPONS[symbol]:
                    object.bullets_shot_this_mag = 0

    elif symbol in PATROL_STATES:
        for object in world.objects:
            if type(object) == Soldier and object.allow_state_selection:
                object.micro_state = PATROL_STATES[symbol]
