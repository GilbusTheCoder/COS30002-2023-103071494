"""A simple procedural style graphics drawing wrapper.

Created for COS30002 AI for Games, by Clinton Woodward <cwoodward@swin.edu.au>
For class use only. Do not publically share or post this code without permission.

This module creates a simple object named "egi", which is an instance of the
EasyGraphics interface, as well as making the pyglet key codes available as
KEY.
...
COLOR_NAMES_255 = {k: rgbaTo255(v) for k, v in COLOR_NAMES.items()}
